...
//var img = [poop, poop1,poop2,poop3];
...
function draw()
{
  ...
  //loadImage("assets/poop.png", function(img) {
  //image(img, x-15, y-15);
  //});
  var shape = ellipse(x, y, radius, radius); // circle that chases the mouse
...
function keyTyped()
{
  ...
  {
    //place a space, blank space (removes the poop emoji)
    // polar to cartesian transformation based on step and currentangle:
